...
#include "FigureActionScale.hpp"

#include "../../../Exceptions/Actions/ActionException.hpp"

void FigureActionScale::setParams(const std::shared_ptr<BaseObject> &object, const std::shared_ptr<BaseTransform> &transform)
{
    ...
    _transform = dynamic_pointer_cast<Scaler>(transform);
...
void FigureActionScale::request() const
{
